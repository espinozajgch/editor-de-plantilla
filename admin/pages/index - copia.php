                        ...
                        <div class="panel-body">
                            ...
                            <h3>Titulo</h3>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="titulo" name="titulo" value="<?php echo Generales::obtener_titulo($bd);?>" tabindex="5">
                                </div>
                            ...
                            <hr>
                                ...
                                if(empty(Generales::obtener_logo_menu($bd))){                 
                                  $codigo.='<div id="retrievingfilename" class="html5imageupload" data-width="288" data-height="100" data-originalsize="false"  data-ghost="false" data-url="../../bin/includes/canvas.php"  >';
                                  $codigo.='<input type="file" name="thumb" />';
                                  $codigo.='</div>';
                                  } 
                                else{                       
                                  $ruta = "../../img/" . Generales::obtener_logo_menu($bd);
                                  $codigo.='<div id="retrievingfilename" class="html5imageupload" data-originalsize="false"  data-ghost="false" data-width="288" data-height="100" data-url="../../bin/includes/canvas.php" data-image="'. $ruta .'" style="width: 288px; height:100px;" >';
                                  $codigo.='<input type="file" name="thumb"/></div>';               
                                }
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="cp1" class="input-group colorpicker-component" title="Using input value">
                                      <input id="menu_bg" name="menu_bg" type="text" class="form-control" value="<?php echo Generales::obtener_menu_bg($bd);?>"/>
                             ...
                             <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="cp2" class="input-group colorpicker-component" title="Using input value">
                                      <input id="body_bg" name="body_bg" type="text" class="form-control" value="<?php echo Generales::obtener_body_bg($bd);?>"/>
                                      <span class="input-group-addon"><i></i></span>
                                    </div>
                                </div>
                            ...
                            <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="cp3" class="input-group colorpicker-component" title="Using input value">
                                      <input id="footer_bg" name="footer_bg" type="text" class="form-control" value="<?php echo Generales::obtener_footer_bg($bd);?>"/>
                                      <span class="input-group-addon"><i></i></span>
                                    </div>
                                </div>
                            <hr>
